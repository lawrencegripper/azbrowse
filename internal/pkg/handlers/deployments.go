...
func (e *DeploymentsExpander) DoesExpand(ctx context.Context, currentItem *TreeNode) (bool, error) {
	if currentItem.ItemType == deploymentType || currentItem.ItemType == subDeploymentType {
		return true, nil
	}
	return false, nil
}
...
func (e *DeploymentsExpander) Expand(ctx context.Context, currentItem *TreeNode) ExpanderResult {
	if currentItem.ItemType == subDeploymentType {
		return ExpanderResult{
			Err:               nil,
			Response:          currentItem.Metadata["deploymentJson"],
